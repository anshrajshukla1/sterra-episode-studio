...
import { auth, signInWithPopup, googleProvider, appleProvider } from '../firebase'
        ...
        <div className="space-y-3">
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.15 2.95.92 3.78 2.29-3.21 1.88-2.58 5.92.51 7.21-.76 1.74-1.74 3.3-2.94 4.51zM11.96 6.8c-.18-3.11 2.38-5.63 5.38-5.8-.3 3.31-3.22 5.67-5.38 5.8z"/>
            </svg>
            Continue with Apple
          </button>
        </div>
